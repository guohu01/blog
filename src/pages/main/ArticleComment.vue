  ...
  <div>
    <div v-clickoutside="hideReplyBtn" @click="inputFocus" class="my-reply">
      ...
      <div class="reply-info">
        <div tabindex="0" contenteditable="true" id="replyInput" spellcheck="false" placeholder="输入评论..." class="reply-input"
          @focus="showReplyBtn" @input="onDivInput($event)">
        </div>
      </div>
    ...
    <div v-for="(item,i) in comments" :key="i" class="author-title reply-father">
      ...
      <div class="reply-box">
        <div v-for="(reply,j) in item.reply" :key="j" class="author-title">
          ...
          <div class="icon-btn">
            <span @click="showReplyInput(i,reply.from,reply.id)"><i class="el-icon-s-comment"></i>{{reply.commentNum}}</span>
